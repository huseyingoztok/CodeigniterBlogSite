...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="<?php echo base_url("Admin/Category/GetAdd") ?>">Kategori Ekle</a>
    </li>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="<?php echo base_url("Admin/Category/PostAdd") ?>" >
                    ...
                    <select name="maincategory_id" class="form-control" id="exampleFormControlSelect1">
                        ...
                        foreach ($categories as $category){
                            if ($category->maincategory_id==null){?>
                                <option  <?php echo isset($errors)? ($category->Id==$selectedId)? "selected":"":"" ?> value="<?php echo "-1" ?>"><?php echo "Root Kategori" ?></option>
                            <?php }
                            ?>
                        <option <?php echo isset($errors)? ($category->Id==$selectedId)? "selected":"":"" ?> value="<?php echo $category->Id ?>"><?php echo $category->category_name ?></option>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input name="category_name" type="text" class="form-control" placeholder="Kategori Adı Giriniz...">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-2">
                    <label>Öncelik</label>
                    <input name="priority" type="number" class="form-control" min="1">
                </div>
            </div>
