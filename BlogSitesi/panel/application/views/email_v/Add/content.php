...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="<?php echo base_url("Admin/Email/GetAdd") ?>">Email Ekle</a>
    </li>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="<?php echo base_url("Admin/Email/PostAdd") ?>" >


            <div class="row">
                <div class="form-group col-md-6">
                    <label>Mail Başlık</label>
                    <input name="send_title" type="text" class="form-control" value="<?php echo (isset($errors)) ? set_value("send_title") : "" ?>" placeholder="Mail Başlık Giriniz...">
                </div>
